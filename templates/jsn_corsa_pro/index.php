...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	<div id="jsn-topheader"  class="<?php echo (($jsnutils->countModules('top'))?'jsn-hastop ':'') ?>  <?php if ((isset($this->socialIcons) AND count($this->socialIcons)) || $this->sitetoolStyle)  echo 'jsn-hastopright' ?>">
