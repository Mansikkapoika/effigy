...
define('JSN_PAGEBUILDER_VERSION', '1.2.3');
define('JSN_PAGEBUILDER_EDITION', 'PRO STANDARD');
...
define('JSN_PAGEBUILDER_BUY_LINK', 'http://www.joomlashine.com/joomla-extensions/jsn-pagebuilder-joomla-page-builder-extension.html');
