		...
		<div class="span12 form-horizontal post-submission-action">
			<fieldset id="postaction">
				...
				<div class="control-group hide" id="form4" style="padding-right: 20px;">
					...
					<div class="controls">
						<?php $customMessage = empty($this->_item->form_id) ? $this->formActionData : $this->actionForm['message']?>
						<textarea id="form_post_action_data4" placeholder="<?php echo JText::_('JSN_UNIFORM_PLACEHOLDER_SHOW_CUSTOM_MESSAGE'); ?>" name="form_post_action_data4" class="jsn-input-xlarge-fluid" rows="10"><?php echo $customMessage; ?></textarea>
					</div>
				</div>
				<!--Mailchim Plugin-->
				<?php
